						...
						<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
							...
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<form class="row g-3 needs-validation" action="<?php echo base_url('index.php/Registrasi/insert'); ?>" method="post">
										<div class="col-12">
										...
										<div class="col-12">
											...
											<input type="text" name="email" class="form-control" id="yourNumber" required>
